window.settings.i18n['vi-VN'] = {
  ...
  '我的邀请': 'Kiếm Tiền Cùng Admin',
  '用户': 'Người Dùng',
  '我的工单': 'Nhắn Tin Với Amin',
  ...
  '折抵': 'Giảm Giá',
  '退款': 'Trả Lại',
  '支付方式': 'Phương Thức Thanh Tóan',
  '填写信用卡支付信息': 'Điền Thông Tin Thẻ Tín Dụng',
  '您的信用卡信息只会被用作当次扣款，系统并不会保存，这是我们认为最安全的。': 'Thông Tin Thẻ Tín Dụng Của Bạn Sẽ Chỉ Được Sử Dụng Cho Lần Thanh Toán Này, Hệ Thống Sẽ Không Lưu Thông Tin Đó, Chúng Tôi Nghĩ Đây Là Cách An Toàn Nhất.',
  ...
  '绑定Telegram': 'Liên Kết Đến Telegram',
  '立即开始': 'Bắt Đầu',
  '重置订阅信息': 'Reset Token',
  '重置': 'Reset',
  ...
  '该订阅长期有效': 'Không Giới Hạn Thời Giani',
  '已过期': 'Hết Hạn',
  '已用 {used} / 总计 {total}': 'Bạn Đã Dùng: {used} / Tổng Dung Lượng: {total}',
  ...
  '一次性': 'Gói Vĩnh Viễn',
  '遇到问题': 'Liên Hệ Hỗ Trợ',
  '遇到问题可以通过工单与我们沟通': 'Tạo đơn hỗ trợ'
};